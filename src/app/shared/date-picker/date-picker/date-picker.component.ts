...
export class DatePickerComponent implements OnInit {
  ...
  constructor(public util: UtilityFunctions) { }
  ...
  yearHandler(normalizedYear: moment.Moment, datepicker: OwlDateTimeComponent<moment.Moment>) {
    try {
  ...
  monthHandler(normalizedMonth: moment.Moment, datepicker: OwlDateTimeComponent<moment.Moment>) {
    try {
      const dateValue = this.date.value;
